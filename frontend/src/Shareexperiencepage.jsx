...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .page-header p {
    font-size: 14.5px; color: var(--muted); line-height: 1.7; max-width: 520px;
  }
  ...
  .form-card-top {
    height: 3px;
    background: linear-gradient(90deg, var(--accent), var(--accent2), var(--rose));
  }
  ...
  /* Divider */
  .form-divider {
    height: 1px; background: var(--card-border); margin: 28px 0;
  }
  ...
  .preview-role { font-size: 12px; font-weight: 600; color: var(--accent); margin-bottom: 6px; }
  .preview-badge {
  ...
  .preview-empty {
    font-size: 12px; color: var(--muted); font-style: italic; text-align: center; padding: 10px 0;
  }
  ...
  .success-desc {
    font-size: 14px; color: var(--muted); line-height: 1.7; max-width: 380px;
  }
...
export default function ShareExperiencePage() {
  ...
  const [form, setForm] = useState({
    name: "", role: "", topic: "", difficulty: "", experience: ""
  });
  ...
  const allValid = Object.values(form).every(Boolean);
  const charCount = form.experience.length;
  ...
  const diffClass = (d) => {
    if (form.difficulty === d) {
      return `diff-pill sel-${d.toLowerCase()}`;
    }
    return "diff-pill";
  };
            ...
            <>
              ...
              <div className="steps-row">
                <div className="step-item">
                  <div className={`step-circle ${filledFields >= 2 ? "done" : "active"}`}>
                    {filledFields >= 2 ? "✓" : "1"}
                  </div>
                  <span className={`step-label ${filledFields < 2 ? "active" : ""}`}>Your Info</span>
                </div>
                <div className="step-connector" />
                <div className="step-item">
                  <div className={`step-circle ${filledFields >= 4 ? "done" : filledFields >= 2 ? "active" : ""}`}>
                    {filledFields >= 4 ? "✓" : "2"}
                  </div>
                  <span className={`step-label ${filledFields >= 2 && filledFields < 4 ? "active" : ""}`}>Interview Details</span>
                </div>
                <div className="step-connector" />
                <div className="step-item">
                  <div className={`step-circle ${allValid ? "done" : filledFields >= 4 ? "active" : ""}`}>
                    {allValid ? "✓" : "3"}
                  </div>
                  <span className={`step-label ${filledFields >= 4 ? "active" : ""}`}>Your Experience</span>
                </div>
              </div>
                ...
                <div className="form-inner">
                  ...
                  <div className="field-full">
                    ...
                    <div className={`char-row ${charClass}`}>
                      {charCount} chars {charCount > 800 ? "— great detail! ✓" : charCount > 400 ? "— keep going…" : "— aim for 400+ chars"}
                    </div>
                  </div>

                  {/* Live Preview */}
                  {(form.name || form.role || form.experience) && (
                    <div className="preview-wrap">
                      ...
                      <div className="preview-card">
                        ...
                        {form.experience
                          ? <div className="preview-body">{form.experience}</div>
                  ...
                  <div className="form-actions">
                    ...
                    <div className="actions-right">
                      ...
                      >
                        {submitting
                          ? <><span>Posting</span><span style={{ animation: "spin 1s linear infinite", display: "inline-block" }}>⟳</span></>
            ...
            <div className="form-card">
              ...
              <div className="success-screen">
                ...
                <p className="success-desc">
                  Thank you, {form.name}! Your interview story has been shared with the community. It might just help someone land their dream job.
                </p>
                <div className="success-actions">
                  <button className="btn-secondary" onClick={() => { setForm({ name: "", role: "", topic: "", difficulty: "", experience: "" }); setSubmitted(false); }}>
                    Share Another
                  </button>
